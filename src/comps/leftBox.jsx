    ...
    return (
        <LineChart width={750} height={200} data={data}
            ...
            <Line type="natural" dataKey="uv" stroke="#ffa500" strokeWidth={4} dot={{ strokeWidth: 2, fill: "orange" }}>
                <LabelList dataKey={"name"} position={"top"} offset={45} stroke={'#D3D3D3'} className="h4" fill="" />
            </Line>
        </LineChart>
    );
}
...
const MainStatBox = (content) => {
    // console.log()
    return (
        <div className="col-lg-5 card my-4 rounded-4 p-auto mx-lg-auto border-0 shadow" style={{ backgroundColor: "#dcdcdc" }}>
            <div className='row'>
